 ...
 *
 */
public class DiffAction extends AbstractResourceAction {

	/**
	 * @param uiStore
	 */
	public DiffAction(UIStore uiStore) {
		super(uiStore);
	}
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		uiStore.getTextArea().setText(strBuff.toString());
